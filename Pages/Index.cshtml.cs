...
namespace FormaGreen.Pages
{
    public class IndexModel : PageModel
    {
        private readonly FormaGreenContext _context;
        ...
        public IndexModel(ILogger<IndexModel> logger, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager, FormaGreenContext context)
        {
            _logger = logger;
